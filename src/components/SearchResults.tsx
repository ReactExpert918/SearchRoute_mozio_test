...
import { Paper,Box,Stack,Divider,Backdrop,Alert,AlertTitle ,CircularProgress,List,ListItem,ListItemText } from '@mui/material'
    ...
    <div>
      {
        ...
        <Paper elevation={3} sx={{padding:"25px",backgroundColor:"black",backdropFilter: "blur(5px)", borderRadius:"10px", margin:"15px",textAlign:"center",display:"flex",flexDirection:"column" }}>
